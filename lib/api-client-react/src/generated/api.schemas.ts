 ...
 */
export type PracticeExamDetails = { [key: string]: unknown };
...
export type CreatePracticeExamInputDetails = { [key: string]: unknown };
...
export type UpdatePracticeExamInputDetails = { [key: string]: unknown };
...
export type ResourceWithStatsTopicStatsItem = {
  topic: string;
  lesson: string;
  total: number;
  solved: number;
...
export type ListPracticeExamsParams = {
  category?: string;
  examType?: string;
};
