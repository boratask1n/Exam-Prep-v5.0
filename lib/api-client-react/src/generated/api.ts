...
export const listResources = async (
  ...
  return customFetch<ResourceWithStats[]>(getListResourcesUrl(params), {
    ...options,
    method: "GET",
  });
};
...
export const getResource = async (
  ...
  return customFetch<ResourceWithStats>(getGetResourceUrl(id), {
    ...options,
    method: "GET",
  });
};
...
export const updateResource = async (
  ...
  return customFetch<Resource>(getUpdateResourceUrl(id), {
    ...
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(updateResourceInput),
  });
};
...
/**
 * @summary List all practice exams
 */
export const getListPracticeExamsUrl = (params?: ListPracticeExamsParams) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/practice-exams?${stringifiedParams}`
    : `/api/practice-exams`;
};

export const listPracticeExams = async (
  params?: ListPracticeExamsParams,
  options?: RequestInit,
): Promise<PracticeExam[]> => {
  return customFetch<PracticeExam[]>(getListPracticeExamsUrl(params), {
    ...options,
    method: "GET",
  });
};

export const getListPracticeExamsQueryKey = (
  params?: ListPracticeExamsParams,
) => {
  return [`/api/practice-exams`, ...(params ? [params] : [])] as const;
};

export const getListPracticeExamsQueryOptions = <
  TData = Awaited<ReturnType<typeof listPracticeExams>>,
  TError = ErrorType<unknown>,
>(
  params?: ListPracticeExamsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listPracticeExams>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListPracticeExamsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listPracticeExams>>
  > = ({ signal }) => listPracticeExams(params, { signal, ...requestOptions });
...
export type ListPracticeExamsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listPracticeExams>>
>;
export type ListPracticeExamsQueryError = ErrorType<unknown>;

/**
 * @summary List all practice exams
 */

export function useListPracticeExams<
  TData = Awaited<ReturnType<typeof listPracticeExams>>,
  TError = ErrorType<unknown>,
>(
  params?: ListPracticeExamsParams,
  ...
  const queryOptions = getListPracticeExamsQueryOptions(params, options);
...
/**
 * @summary Create a practice exam
 */
export const getCreatePracticeExamUrl = () => {
  return `/api/practice-exams`;
};

export const createPracticeExam = async (
  createPracticeExamInput: CreatePracticeExamInput,
  options?: RequestInit,
): Promise<PracticeExam> => {
  return customFetch<PracticeExam>(getCreatePracticeExamUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(createPracticeExamInput),
  });
};

export const getCreatePracticeExamMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof createPracticeExam>>,
    TError,
    { data: BodyType<CreatePracticeExamInput> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["createPracticeExam"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return createPracticeExam(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type CreatePracticeExamMutationResult = NonNullable<
  Awaited<ReturnType<typeof createPracticeExam>>
>;
export type CreatePracticeExamMutationBody = BodyType<CreatePracticeExamInput>;
export type CreatePracticeExamMutationError = ErrorType<unknown>;

/**
 * @summary Create a practice exam
 */
export const useCreatePracticeExam = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getCreatePracticeExamMutationOptions(options));
};

/**
 * @summary Get practice exam details
 */
export const getGetPracticeExamUrl = (id: number) => {
  return `/api/practice-exams/${id}`;
};
...
export const getPracticeExam = async (
  ...
  return customFetch<PracticeExam>(getGetPracticeExamUrl(id), {
    ...options,
    method: "GET",
  });
};

export const getGetPracticeExamQueryKey = (id: number) => {
  return [`/api/practice-exams/${id}`] as const;
};

export const getGetPracticeExamQueryOptions = <
  TData = Awaited<ReturnType<typeof getPracticeExam>>,
  TError = ErrorType<unknown>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getPracticeExam>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetPracticeExamQueryKey(id);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getPracticeExam>>> = ({
    signal,
  }) => getPracticeExam(id, { signal, ...requestOptions });
...
export type GetPracticeExamQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPracticeExam>>
>;
export type GetPracticeExamQueryError = ErrorType<unknown>;

/**
 * @summary Get practice exam details
 */

export function useGetPracticeExam<
  TData = Awaited<ReturnType<typeof getPracticeExam>>,
  TError = ErrorType<unknown>,
>(
  id: number,
  ...
  const queryOptions = getGetPracticeExamQueryOptions(id, options);
...
/**
 * @summary Update a practice exam
 */
export const getUpdatePracticeExamUrl = (id: number) => {
  return `/api/practice-exams/${id}`;
};

export const updatePracticeExam = async (
  id: number,
  updatePracticeExamInput: UpdatePracticeExamInput,
  options?: RequestInit,
): Promise<PracticeExam> => {
  return customFetch<PracticeExam>(getUpdatePracticeExamUrl(id), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(updatePracticeExamInput),
  });
};

export const getUpdatePracticeExamMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updatePracticeExam>>,
    TError,
    { id: number; data: BodyType<UpdatePracticeExamInput> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["updatePracticeExam"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return updatePracticeExam(id, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type UpdatePracticeExamMutationResult = NonNullable<
  Awaited<ReturnType<typeof updatePracticeExam>>
>;
export type UpdatePracticeExamMutationBody = BodyType<UpdatePracticeExamInput>;
export type UpdatePracticeExamMutationError = ErrorType<unknown>;

/**
 * @summary Update a practice exam
 */
export const useUpdatePracticeExam = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getUpdatePracticeExamMutationOptions(options));
};

/**
 * @summary Delete a practice exam
 */
export const getDeletePracticeExamUrl = (id: number) => {
  return `/api/practice-exams/${id}`;
};

export const deletePracticeExam = async (
  id: number,
  options?: RequestInit,
): Promise<void> => {
  return customFetch<void>(getDeletePracticeExamUrl(id), {
    ...options,
    method: "DELETE",
  });
};

export const getDeletePracticeExamMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deletePracticeExam>>,
    TError,
    { id: number },
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ["deletePracticeExam"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return deletePracticeExam(id, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type DeletePracticeExamMutationResult = NonNullable<
  Awaited<ReturnType<typeof deletePracticeExam>>
>;

export type DeletePracticeExamMutationError = ErrorType<unknown>;

/**
 * @summary Delete a practice exam
 */
export const useDeletePracticeExam = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getDeletePracticeExamMutationOptions(options));
};
