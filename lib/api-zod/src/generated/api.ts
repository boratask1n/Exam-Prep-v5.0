...
export const ListQuestionsResponseItem = zod.object({
  ...
  solutionYoutubeEndSecond: zod.number().nullish(),
...
export const ListResourcesResponseItem = zod
  .object({
    id: zod.number(),
    name: zod.string(),
    publisher: zod.string().nullish(),
    ...
    targetQuestionCount: zod.number().nullish(),
    createdAt: zod.string(),
    updatedAt: zod.string(),
  })
  .and(
    zod.object({
      ...
      solvedQuestions: zod.number().optional(),
      correctQuestions: zod.number().optional(),
      wrongQuestions: zod.number().optional(),
...
export const GetResourceResponse = zod
  .object({
    id: zod.number(),
    name: zod.string(),
    publisher: zod.string().nullish(),
 ...
 */
export const ListPracticeExamsQueryParams = zod.object({
  category: zod.coerce.string().optional(),
  examType: zod.coerce.string().optional(),
});

export const ListPracticeExamsResponseItem = zod.object({
  id: zod.number(),
  title: zod.string(),
  examType: zod.string(),
  category: zod.string(),
...
export const ListPracticeExamsResponse = zod.array(
  ListPracticeExamsResponseItem,
);

/**
 * @summary Create a practice exam
 */
export const CreatePracticeExamBody = zod.object({
  title: zod.string(),
  examType: zod.string(),
  category: zod.string(),
  resourceId: zod.number().nullish(),
 ...
 */
export const UpdatePracticeExamParams = zod.object({
  id: zod.coerce.number(),
});

export const UpdatePracticeExamBody = zod.object({
...
export const UpdatePracticeExamResponse = zod.object({
  id: zod.number(),
  title: zod.string(),
  examType: zod.string(),
  category: zod.string(),
 ...
 */
export const DeletePracticeExamParams = zod.object({
  id: zod.coerce.number(),
});
