            ...
            {solutionVideoUrl ? (
              isYoutube ? (
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border border-blue-300/50 bg-blue-500/10 px-2.5 py-1 font-medium text-blue-700 transition-colors hover:bg-blue-500/15 dark:border-blue-400/20 dark:text-blue-200"
                >
